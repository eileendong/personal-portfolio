  ...
  <div className="relative z-10"></div>
      ...
      <nav className="flex justify-between items-center p-6 sticky top-0 z-50 bg-black/30 backdrop-blur-xl border-b border-white/10">
        ...
        <div className="space-x-6 text-sm">
          ...
          <button
            onClick={toggleTheme}
            className="border px-3 py-1 rounded-full backdrop-blur-sm bg-white/10 hover:bg-white/20 transition"
          >
            {theme === "dark" ? "😆" : "🥸"}
          </button>
        </div>
  ...
  <div className="grid md:grid-cols-4 sm:grid-cols-2 grid-cols-1 gap-10 max-w-6xl w-full justify-items-center">
    {[
      ...
      >
        {/* Gradient glow layer */}
        <div
          className={`absolute inset-0 bg-gradient-to-br ${p.glow} opacity-0 group-hover:opacity-100 transition-opacity duration-500`}
        ></div>
        ...
        <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-white/0 via-white/0 to-white/[0.03] opacity-0 group-hover:opacity-100 transition duration-500"></div>
        ...
        <div className="mt-6 relative z-10">
          <a
            ...
            className="inline-block text-sm text-white/80 hover:text-white hover:underline transition-all"
          >
            View on GitHub →
          </a>
        </div>
  ...
  <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-14">
    {[
      ...
      },
      {
        ...
        items: [
          { name: "React ⚛️", level: 4 },
          { name: "FastAPI 🚀", level: 5 },
          { name: "LangChain 🤖", level: 4 },
          { name: "LlamaIndex 🦙", level: 3 },
      ...
      },
      {
        ...
        items: [
          { name: "Docker 🐳", level: 4 },
          { name: "Kubernetes ☸️", level: 3 },
          { name: "AWS ☁️", level: 3 },
          { name: "GitLab CI/CD 🔁", level: 4 },
          { name: "Ansible ⚙️", level: 2 },
          { name: "Linux 🐧", level: 4 },
        ],
      },
      {
        ...
        items: [
          { name: "APIs 🔗", level: 5 },
          { name: "Concurrent Programming 🧩", level: 4 },
          { name: "Distributed Systems 🌐", level: 4 },
          { name: "TCP Socket Programming 📡", level: 3 },
          { name: "Observability (Prometheus, OTel) 📈", level: 4 },
        ],
      },
    ].map((cat, i) => (
      <motion.div
        ...
        className="space-y-6"
      >
        <h3 className="text-xl font-medium mb-6 text-white-300/90 tracking-wide">
          {cat.category}
        </h3>
